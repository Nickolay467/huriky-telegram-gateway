...
import { ExternalLink, Shield, Zap, Globe, Wifi, MessageSquare } from "lucide-react";
          ...
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              <div className="inline-block rounded-lg bg-telegram-darker px-3 py-1 text-sm">
                <span className="text-telegram-yellow font-medium">Secure VPN Access</span>
              </div>
              ...
              <p className="max-w-[600px] text-gray-300 md:text-xl">
                Fast, secure, and reliable VLESS VPN access through our Telegram bot. Stay protected with a private connection anywhere in the world.
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              <Button className="bg-telegram-blue hover:bg-telegram-blue/90 text-white rounded-xl px-8 py-6 text-lg font-medium" asChild>
                <a href="https://t.me/hurikynetwork_bot" target="_blank" rel="noopener noreferrer">
                  Start using the Bot <ExternalLink className="ml-2 h-5 w-5" />
                </a>
              </Button>
            </div>
          </div>
          <div className="flex justify-center mt-8 lg:mt-0">
            <div className="relative w-[280px] md:w-[320px] lg:w-[380px] overflow-hidden rounded-2xl bg-telegram-darker shadow-xl border border-telegram-card">
              <img 
                src="/lovable-uploads/dfc813fb-1801-4c81-96f6-31e392411529.png" 
                alt="HurikyNetwork Telegram Bot Interface" 
